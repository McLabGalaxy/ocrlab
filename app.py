...
with col1:
   st.header("PNG")
   st.image("static/receipt_file.png")
   st.markdown("Image file 26.6 KB .  original scanned reciept image.")

with col2:
   st.header("OCR Text")
   st.image("static/text_file.png")
   st.markdown("convert from PNG 1.5 KB (⬇️94%) keep coordinates and detected content")

with col3:
   st.header("SVG")
   st.image("static/svg_file.png")
   st.markdown(""" trace from PNG 15.8 KB (⬇️41%). 
               output similar to original
               """)

with col4:
   st.header("PDF")
   st.image("static/pdf_file.png")
   st.markdown("convert from SVG 5.8 KB (⬇️78%). output similar to original")   
